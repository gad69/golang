...
type parameters struct {
	arr [100]float64
	n   int
} // structure(for encapsulating the functions below) to pass into 3 functions
...
func main() {
	...
	if n <= 100 && n > 0 {
		...
		p := parameters{array, n}                                                                // structure variable used in getstandard_dev()                                                           // structure variable used in getmedian()
